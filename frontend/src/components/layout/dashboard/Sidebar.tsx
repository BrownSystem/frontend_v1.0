    ...
    <div className="w-[100px] h-full bg-gradient-to-b from-[var(--brown-ligth-400)] to-[var(--brown-dark-800)] rounded-tr-full">
      <div className="flex flex-col w-full h-full items-end pt-20 gap-[35px]">
        ...
        >
          ...
          >
            <path
              d="M9 18C9.82843 18 10.5 18.6716 10.5 19.5C10.5 20.3284 9.82843 21 9 21C8.17157 21 7.5 20.3284 7.5 19.5C7.5 18.6716 8.17157 18 9 18Z"
              stroke="white"
              stroke-width="1.5"
            ></path>
            <path
              d="M16 18C16.8284 18 17.5 18.6716 17.5 19.5C17.5 20.3284 16.8284 21 16 21C15.1716 21 14.5 20.3284 14.5 19.5C14.5 18.6716 15.1716 18 16 18Z"
              stroke="white"
              stroke-width="1.5"
            ></path>
            <path
              d="M5.75 12C5.75 10.5646 5.75159 9.56347 5.85315 8.80812C5.9518 8.07434 6.13225 7.68577 6.40901 7.40901C6.68577 7.13225 7.07434 6.9518 7.80812 6.85315C8.56347 6.75159 9.56458 6.75 11 6.75H13.9172C15.5841 6.75 16.7537 6.75179 17.623 6.87517C18.4715 6.9956 18.8954 7.21511 19.1754 7.54566C19.4554 7.8762 19.6023 8.33044 19.5816 9.18719C19.5604 10.0649 19.3698 11.2189 19.0958 12.8631C18.8931 14.0793 18.7511 14.9228 18.5629 15.5551C18.3807 16.1672 18.1794 16.4911 17.913 16.7168C17.6465 16.9425 17.294 17.0878 16.6602 17.1669C16.0056 17.2486 15.1503 17.25 13.9172 17.25H11C9.56458 17.25 8.56347 17.2484 7.80812 17.1469C7.07434 17.0482 6.68577 16.8678 6.40901 16.591C6.13225 16.3142 5.9518 15.9257 5.85315 15.1919C5.75159 14.4365 5.75 13.4354 5.75 12Z"
              stroke="white"
              stroke-width="1.5"
            ></path>
            <path
              d="M5.75 11.5V5C5.75 3.89543 4.85457 3 3.75 3H2.5"
              stroke="white"
              stroke-width="1.5"
